...
[Icons]
Name: "{group}\AIDEM"; Filename: "{app}\AIDEM.exe"
Name: "{autodesktop}\AIDEM"; Filename: "{app}\AIDEM.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\AIDEM.exe"; Description: "{cm:LaunchProgram,AIDEM}"; Flags: nowait postinstall skipifsilent
